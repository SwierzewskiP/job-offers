...
public class OfferHttpClient implements OfferFetchable {
    ...
    public List<JobOfferServiceDto> fetchOffers() {
        ...
        try {
            ...
            ResponseEntity<List<JobOfferServiceDto>> response = restTemplate.exchange(url, HttpMethod.GET, requestEntity,
                    new ParameterizedTypeReference<>() {
                    });
            final List<JobOfferServiceDto> body = response.getBody();
            if (body == null) {
